// =========================================================
// LESSONS REPOSITORY — BẢO TÀNG SỐ DI SẢN BÙ ĐĂNG
// Single Source of Truth for Educational Curriculum & Lessons
// =========================================================
...
export const LESSONS_DATA: Record<string, LessonData> = {
  'chien-khu-d': {
    ...
    objectives: [
      'Trình bày được vị trí địa lý chiến lược và vai trò căn cứ địa kháng chiến của Chiến Khu Đ giai đoạn 1945–1975.',
      'Phân tích sự đóng góp to lớn của đồng bào S\'tiêng và M\'nông trong hoạt động tiếp vận, nuôi giấu cán bộ.',
      'Đánh giá giá trị lịch sử của Chiến Khu Đ trong sự nghiệp giải phóng miền Đông Nam Bộ và thống nhất đất nước.',
    ],
    relatedHeritage: {
      slug: 'can-cu-nua-lon-bu-dang',
      name: 'Căn Cứ Nửa Lon Bù Đăng',
      desc: 'Di tích căn cứ kháng chiến kiên cường thuộc hệ thống Chiến Khu Đ.',
    },
    coreKnowledge: {
    ...
    relatedPlaces: [
      { name: 'Sóc Bom Bo', desc: 'Địa danh lịch sử gắn với bài hát "Tiếng Chày Trên Sóc Bom Bo"', poiId: 'place-soc-bom-bo' },
  ...
  'cong-chieng-stieng': {
    ...
    objectives: [
      'Nhận biết được ý nghĩa tâm linh của vị thần Yang Ching trong tín ngưỡng cồng chiêng S\'tiêng.',
      'Phân biệt cấu trúc dàn chiêng: Ching Mẹ (Ching u), Ching Cha, Ching Con và trống đệm Kơ-gơr.',
      'Nêu được giá trị di sản văn hóa cồng chiêng và đề xuất giải pháp bảo tồn cho thế hệ trẻ.',
    ],
    relatedHeritage: {
      slug: 'le-hoi-cong-chieng-stieng',
      name: 'Lễ Hội Cồng Chiêng S\'tiêng',
      desc: 'Không gian văn hóa phi vật thể thiêng liêng chung cội nguồn Tây Nguyên.',
    },
    coreKnowledge: {
    ...
    relatedPlaces: [
      { name: 'Sóc Bom Bo', desc: 'Địa điểm bảo tồn nghệ thuật cồng chiêng truyền thống', poiId: 'place-soc-bom-bo' },
    ],
    references: [
  ...
  'soc-bom-bo': {
    ...
    objectives: [
      'Hiểu được hoàn cảnh lịch sử đêm giã gạo nuôi quân phục vụ chiến dịch Phước Long – Đồng Xoài (1965).',
      'Phân tích ý nghĩa biểu tượng của hình ảnh "tiếng chày trên Sóc Bom Bo" trong âm nhạc và lịch sử.',
      'Khám phá không gian văn hóa, hiện vật và mô hình nhà dài tại Khu bảo tồn văn hóa dân tộc S\'tiêng sóc Bom Bo.',
    ],
    relatedHeritage: {
      slug: 'khu-bao-ton-soc-bom-bo',
      name: 'Khu Bảo Tồn Sóc Bom Bo',
      desc: 'Nơi lưu giữ ký ức đêm giã gạo nuôi quân và văn hóa bản địa S\'tiêng.',
    },
    coreKnowledge: {
    ...
    quiz: [
      ...
      },
      {
        ...
        options: ['Trịnh Công Sơn', 'Văn Cao', 'Xuân Hồng', 'Phạm Tuyên'],
        correct: 2,
        explanation: 'Nhạc sĩ Xuân Hồng sáng tác ca khúc bất hủ này năm 1966 sau khi đến thăm Sóc Bom Bo.',
      },
      {
        question: 'Vì sao bà con Sóc Bom Bo phải giã gạo vào ban đêm dưới ánh đuốc lồ ô?',
        options: ['Vì ban ngày bận làm nương rẫy', 'Vì ban ngày máy bay địch oanh tạc, ban đêm giã gạo an toàn hơn', 'Vì ban đêm gạo mới trắng', 'Theo phong tục truyền thống'],
        correct: 1,
        explanation: 'Do ban ngày máy bay địch liên tục bắn phá, bà con chuyển sang giã gạo ban đêm dưới ánh đuốc lồ ô.',
      },
      {
        question: 'Hình thức giã gạo "chày đôi, chày ba" có tác dụng gì?',
        options: ['Tạo âm thanh vui nhộn', 'Phối hợp 2-3 người cùng một cối để tăng năng suất giã gạo nuôi quân', 'Biểu diễn cho du khách xem', 'Tiết kiệm củi đốt'],
        correct: 1,
        explanation: 'Nhịp chày đôi, chày ba giúp tăng tốc độ giã gạo, cung cấp kịp thời hàng tấn gạo cho bộ đội.',
      },
      {
        question: 'Khu bảo tồn văn hóa dân tộc S\'tiêng sóc Bom Bo hiện nay có điểm gì nổi bật?',
        options: ['Chỉ có một tấm bia đá nhỏ', 'Phục dựng nhà dài truyền thống, lưu giữ cối chày, cồng chiêng và tổ chức trải nghiệm văn hóa', 'Là khu công nghiệp chế biến gạo', 'Đã chuyển thành sân bay'],
        correct: 1,
        explanation: 'Khu bảo tồn phục dựng trọn vẹn không gian nhà dài, lưu giữ hiện vật lịch sử và là điểm du lịch văn hóa – lịch sử nổi tiếng.',
      },
    ],
    essay: {
      prompt: 'Hãy viết một đoạn văn ngắn (100–200 chữ) nêu cảm nghĩ của bạn về hình ảnh "tiếng chày trên sóc Bom Bo" trong cuộc kháng chiến chống Mỹ.',
      hint: 'Gợi ý: tinh thần đoàn kết dân tộc, sự hy sinh thầm lặng của đồng bào S\'tiêng, và bài học về lòng yêu nước cho thế hệ trẻ.',
    },
    relatedPlaces: [
      { name: 'Khu Bảo Tồn Văn Hóa Dân Tộc S\'tiêng Sóc Bom Bo', desc: 'Địa chỉ đỏ lưu giữ hiện vật, nhà dài truyền thống và không gian văn hóa S\'tiêng.' },
      { name: 'Chiến Khu Đ', desc: 'Căn cứ địa cách mạng mà Sóc Bom Bo từng phục vụ tiếp tế hậu cần.' },
    ],
    references: [
      { title: 'Lịch sử Đảng bộ tỉnh Bình Phước (1930 - 2000)', source: 'NXB Chính trị Quốc gia, 2004' },
  ...
  'trang-co-bu-lach': {
    ...
    objectives: [
      'Mô tả được đặc điểm địa hình, thổ nhưỡng tầng đất bazan và hệ sinh thái thảm cỏ kim hiếm gặp tại Trảng cỏ Bù Lạch.',
      'Giải thích được truyền thuyết tâm linh "Gương thần của trời đất" trong thế giới quan người S\'tiêng.',
      'Đề xuất giải pháp phát triển du lịch sinh thái bền vững gắn với bảo vệ môi trường tự nhiên.',
    ],
    relatedHeritage: {
      slug: 'trang-co-bu-lach',
      name: 'Danh Thắng Trảng Cỏ Bù Lạch',
      desc: 'Thảo nguyên xanh tự nhiên hơn 140 ha ôm trọn hồ nước ngọt giữa rừng già.',
    },
    coreKnowledge: {
  ...
  'nui-ba-ra': {
    ...
    objectives: [
      'Nắm vững đặc điểm địa lý tự nhiên của Núi Bà Rá (đỉnh núi cao 723m, đứng thứ 3 Nam Bộ).',
      'Trình bày được tội ác thực dân tại Nhà tù Bà Rá (1930) và ý nghĩa trận đánh làm chủ điểm cao ngày 02/01/1975.',
      'Phân tích giá trị tổng hợp giữa danh lam thắng cảnh và di tích lịch sử cách mạng đối với địa phương.',
    ],
    relatedHeritage: {
      slug: 'nui-ba-ra-phuoc-long',
      name: 'Núi Bà Rá — Phước Long',
      desc: 'Đỉnh núi cao 723m đứng thứ 3 Nam Bộ, di tích Nhà tù Bà Rá và cứ điểm chiến dịch 1975.',
    },
    coreKnowledge: {
  ...
  'can-cu-nua-lon': {
    ...
    objectives: [
      'Hiểu được nguồn gốc tên gọi và ý nghĩa lịch sử của di tích Căn cứ Nửa Lon giai đoạn 1960–1965.',
      'Làm rõ vai trò bản lề của căn cứ trong việc mở đường, bảo vệ hành lang chiến lược Bắc — Nam đường mòn Hồ Chí Minh.',
      'Tự hào và noi gương tinh thần vượt khó, nhường cơm sẻ áo của các anh hùng liệt sĩ Điểu Ong, Điểu Kâu.',
    ],
    relatedHeritage: {
      slug: 'can-cu-nua-lon-bu-dang',
      name: 'Căn Cứ Nửa Lon Bù Đăng',
      desc: 'Biểu tượng ý chí vượt gian khó chia nhau nửa lon gạo mở hành lang chiến lược.',
    },
    coreKnowledge: {
  ...
  'chien-thang-phuoc-long': {
    ...
    objectives: [
      'Trình bày được diễn biến 25 ngày đêm của Chiến dịch Đường 14 – Phước Long (13/12/1974 – 06/01/1975).',
      'Phân tích vì sao Chiến thắng Phước Long được đánh giá là "đòn trinh sát chiến lược" quyết định mở Tổng tiến công 1975.',
      'Đánh giá ý nghĩa lịch sử của việc Phước Long trở thành tỉnh đầu tiên ở miền Nam được giải phóng hoàn toàn.',
    ],
    relatedHeritage: {
      slug: 'chien-thang-phuoc-long-1975',
      name: 'Chiến Thắng Phước Long 1975',
      desc: 'Đòn trinh sát chiến lược giải phóng tỉnh đầu tiên ở miền Nam ngày 06/01/1975.',
    },
    coreKnowledge: {
  ...
  'can-cu-ta-thiet': {
    ...
    objectives: [
      'Nắm được quy mô, vị trí và vai trò đầu não của Bộ Tư lệnh Miền tại Căn cứ Tà Thiết giai đoạn 1973–1975.',
      'Mô tả được nghệ thuật xây dựng công sự nhà bán âm lợp lá trung quân và giao thông hào bí mật.',
      'Hiểu được ý nghĩa lịch sử nơi thành lập Bộ Chỉ huy Chiến dịch Hồ Chí Minh giải phóng Sài Gòn.',
    ],
    relatedHeritage: {
      slug: 'can-cu-ta-thiet-loc-ninh',
      name: 'Căn Cứ Tà Thiết Lộc Ninh',
      desc: 'Di tích quốc gia đặc biệt "Rừng Chính phủ" — cơ quan đầu não Bộ Chỉ huy Miền.',
    },
    coreKnowledge: {
  ...
  'tho-cam-stieng': {
    ...
    objectives: [
      'Nhận diện được quy trình khai thác thảo mộc tự nhiên (vỏ cây Krông, củ nghệ rừng, lá chàm) để nhuộm màu chỉ dệt.',
      'Giải mã ý nghĩa biểu tượng của các hoa văn thổ cẩm S\'tiêng (họa tiết hạt gạo Sơk Pơng, cánh chim, ngọn núi).',
      'Hiểu được vai trò của nghề dệt trong đời sống gia đình mẫu hệ và đề xuất giải pháp phát triển sản phẩm lưu niệm.',
    ],
    relatedHeritage: {
      slug: 'lang-nghe-det-tho-cam-stieng',
      name: 'Làng Nghề Dệt Thổ Cẩm S\'tiêng',
      desc: 'Nghệ thuật dệt hoa văn hình thoi Sơk Pơng và kỹ thuật nhuộm màu thảo mộc rừng.',
    },
    coreKnowledge: {
  ...
  'thac-dung-dak-wuar': {
    ...
    objectives: [
      'Giải thích được cơ chế kiến tạo địa chất hình thành vách đá bazan dạng cột lục lăng tại Thác Đứng.',
      'Mô tả được đặc điểm cảnh quan thủy văn của suối Đăk Wuar qua hai mùa mưa - khô.',
      'Nâng cao ý thức bảo vệ môi trường sinh thái dòng suối và danh lam thắng cảnh địa phương.',
    ],
    relatedHeritage: {
      slug: 'thac-dung-bu-dang',
      name: 'Danh Thắng Thác Đứng Bù Đăng',
      desc: 'Kỳ quan địa chất bazan cột lục lăng trên dòng suối Đăk Wuar.',
    },
    coreKnowledge: {
