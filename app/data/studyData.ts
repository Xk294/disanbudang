...
export const staticResources: SchoolResourceExtended[] = [
  ...
  },
  {
    ...
    description: 'Tài liệu lịch sử hành trình phát triển của vùng đất Biên Hòa — Đồng Nai qua các thời kỳ lịch sử.',
    type: 'document', subject: 'Lịch sử địa phương', grade: 'Tài liệu gốc',
    school: 'Di sản Thành Phố Đồng Nai', author: 'Ban Tài liệu Di sản',
    coverImage: '/images/heritage/lich-su/chien-khu-d-md.webp',
    publishedAt: '2024-01-01', featured: false, downloadCount: 0, fileSize: '415 KB',
    fileUrl: '/tai-lieu/bien-hoa-dong-nai-hanh-trinh-phat-trien.pdf',
    motivation: 'Tài liệu gốc về hành trình phát triển của Biên Hòa và Đồng Nai qua các thời kỳ. Có thể tải về và sử dụng trực tiếp.',
    keyFindings: ['Hành trình phát triển Biên Hòa qua các giai đoạn lịch sử.', 'Tài liệu gốc do ban tài liệu di sản Đồng Nai biên soạn.', 'Có thể tải về dưới dạng PDF để đọc offline.'],
  },
  {
    id: 'res-010',
    title: 'Căn Cứ U1 — Vang Bóng Một Thời',
    description: 'Tài liệu lịch sử về Căn Cứ U1 — một trong những căn cứ quân sự quan trọng của kháng chiến.',
    type: 'document', subject: 'Lịch sử cách mạng', grade: 'Tài liệu gốc',
    school: 'Di sản Thành Phố Đồng Nai', author: 'Ban Tài liệu Di sản',
    coverImage: '/images/heritage/lich-su/chien-khu-d-md.webp',
    publishedAt: '2024-01-01', featured: false, downloadCount: 0, fileSize: '1.4 MB',
    fileUrl: '/tai-lieu/can-cu-u1.pdf',
    motivation: 'Hồ sơ chính thức về Căn Cứ U1, nơi ghi dấu những năm tháng kháng chiến hào hùng.',
    keyFindings: ['Lịch sử hình thành và hoạt động của Căn Cứ U1.', 'Vai trò chiến lược trong kháng chiến miền Đông Nam Bộ.', 'Có thể tải về dưới dạng PDF để đọc offline.'],
  },
  {
    id: 'res-011',
    title: 'Chiến Khu Đ — Căn Cứ Địa Kháng Chiến',
    description: 'Tài liệu đầy đủ về Chiến Khu Đ, hệ thống căn cứ địa quan trọng bậc nhất khu vực miền Đông Nam Bộ.',
    type: 'document', subject: 'Lịch sử cách mạng', grade: 'Tài liệu gốc',
    school: 'Di sản Thành Phố Đồng Nai', author: 'Ban Tài liệu Di sản',
    coverImage: '/images/heritage/lich-su/chien-khu-d-md.webp',
    publishedAt: '2024-01-01', featured: false, downloadCount: 0, fileSize: '577 KB',
    fileUrl: '/tai-lieu/chien-khu-d.pdf',
    motivation: 'Hành trình của Chiến Khu Đ từ những ngày đầu kháng chiến đến ngày giải phóng miền Nam.',
    keyFindings: ['Lịch sử và vai trò chiến lược của Chiến Khu Đ.', 'Các trận đánh và sự kiện quan trọng.', 'Có thể tải về dưới dạng PDF để đọc offline.'],
  },
  {
    id: 'res-012',
    title: 'Hành Trình Mở Cõi Phương Nam — Trấn Biên',
    description: 'Tài liệu về hành trình khẩn hoang mở cõi phương Nam và quá trình hình thành vùng đất Trấn Biên xưa.',
    type: 'document', subject: 'Lịch sử khai khẩn', grade: 'Tài liệu gốc',
    school: 'Di sản Thành Phố Đồng Nai', author: 'Ban Tài liệu Di sản',
    coverImage: '/images/heritage/img-disanbudang/Can-cu-Ta-Thiet.jpg',
    publishedAt: '2024-01-01', featured: false, downloadCount: 0, fileSize: '907 KB',
    fileUrl: '/tai-lieu/hanh-trinh-mo-coi-phuong-nam-tran-bien.pdf',
    motivation: 'Hành trình người Việt khẩn hoang vào phương Nam, xây dựng vùng đất Trấn Biên định mệnh.',
    keyFindings: ['Quá trình hình thành và phát triển vùng đất Trấn Biên.', 'Các lớp lưu dân và quá trình khai khẩn từ thế kỷ XVII.', 'Có thể tải về dưới dạng PDF để đọc offline.'],
  },
  {
    id: 'res-013',
    title: 'Sóc Bom Bo Trong Dòng Chảy Lịch Sử Đồng Nai',
    description: 'Tài liệu ghi lại vị trí và vai trò của Sóc Bom Bo trong lịch sử kháng chiến Đồng Nai.',
    type: 'document', subject: 'Lịch sử cách mạng', grade: 'Tài liệu gốc',
    school: 'Di sản Thành Phố Đồng Nai', author: 'Ban Tài liệu Di sản',
    coverImage: '/images/heritage/lich-su/soc-bom-bo-lg.webp',
    publishedAt: '2024-01-01', featured: false, downloadCount: 0, fileSize: '1.0 MB',
    fileUrl: '/tai-lieu/soc-bom-bo-dong-nai.pdf',
    motivation: 'Sóc Bom Bo — vùng đất huyền thoại nơi tiếng chày giã gạo nuôi quân vang xa trong đêm tối.',
    keyFindings: ["Lịch sử Sóc Bom Bo trong kháng chiến chống Mỹ.", "Đồng bào S'tiêng và đêm giã gạo nuôi quân nổi tiếng.", 'Có thể tải về dưới dạng PDF để đọc offline.'],
  },
  {
    id: 'res-014',
    title: 'Đồng Nai Hôm Nay Và Khát Vọng Vươn Lên',
    description: 'Tài liệu về sự phát triển hiện đại của Đồng Nai và khát vọng vươn lên của vùng đất.',
    type: 'document', subject: 'Kinh tế — Phát triển', grade: 'Tài liệu gốc',
    school: 'Di sản Thành Phố Đồng Nai', author: 'Ban Tài liệu Di sản',
    coverImage: '/images/heritage/img-disanbudang/Can-cu-Ta-Thiet.jpg',
    publishedAt: '2024-01-01', featured: false, downloadCount: 0, fileSize: '877 KB',
    fileUrl: '/tai-lieu/dong-nai-hom-nay-khat-vong-vuon-len.pdf',
    motivation: 'Đồng Nai — từ vùng đất kháng chiến đến đô thị hiện đại đầy sức sống và khát vọng.',
    keyFindings: ['Quá trình phát triển kinh tế xã hội Đồng Nai sau giải phóng.', 'Các mục tiêu và định hướng phát triển tương lai.', 'Có thể tải về dưới dạng PDF để đọc offline.'],
  },
  {
    id: 'res-015',
    title: 'Đồng Nai — Những Năm Tháng Kháng Chiến',
    description: 'Tài liệu ghi lại những năm tháng kháng chiến hào hùng của quân và dân Đồng Nai.',
    type: 'document', subject: 'Lịch sử cách mạng', grade: 'Tài liệu gốc',
    school: 'Di sản Thành Phố Đồng Nai', author: 'Ban Tài liệu Di sản',
    coverImage: '/images/heritage/lich-su/chien-khu-d-md.webp',
    publishedAt: '2024-01-01', featured: false, downloadCount: 0, fileSize: '996 KB',
    fileUrl: '/tai-lieu/dong-nai-nhung-nam-thang-khang-chien.pdf',
    motivation: 'Biên niên sử của những năm tháng kháng chiến gây cấn của quân và dân Đồng Nai.',
    keyFindings: ['Các trận chiến lịch sử trên đất Đồng Nai.', 'Sự hy sinh và đóng góp của nhân dân Đồng Nai.', 'Có thể tải về dưới dạng PDF để đọc offline.'],
  },
]
